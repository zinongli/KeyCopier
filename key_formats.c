...
const KeyFormat all_formats[] = {
...

    {
        ...
        .elbow_inch = 0.1,
        .drill_angle = 90, // This should actually be 100 but the current resolution will make 100 degrees very ugly and unusable
...

    {
        ...
        .elbow_inch = 0.1,
        .drill_angle = 105, // This should actually be 100 but the current resolution will make 100 degrees very ugly and unusable
        .uncut_depth_inch = 0.335,
...

    {
        ...
        .elbow_inch = 0.1,
        .drill_angle = 80, // This should actually be 100 but the current resolution will make 100 degrees very ugly and unusable
