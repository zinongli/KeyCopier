...
const KeyFormat all_formats[] = {
    ...
    // Deutsche Schluesselformate
    {.manufacturer = "ABUS",
        .format_name = "ABUS Profil XP2",
        .format_link = "https://www.abus.com/de",
        .sides = 2,
        .stop = 0,
        .first_pin_inch = 0.157,
        .last_pin_inch = 0.945,
        ...
        .clearance = 0},
       {.manufacturer = "EVVA",
        .format_name = "EVVA ICS",
        .format_link = "https://www.evva.com/de-de/",
        .sides = 2,
        .stop = 0,
        .first_pin_inch = 0.150,
        .last_pin_inch = 0.900,
        .pin_increment_inch = 0.150,
        .pin_num = 6,
        .pin_width_inch = 0.035,
        .elbow_inch = 0.0,
        .drill_angle = 0.0,
        .uncut_depth_inch = 0.300,
       ...
       {.manufacturer = "Winkhaus",
        .format_name = "Winkhaus X-pert",
        .format_link = "https://www.winkhaus.com/de",
        .sides = 2,
        .stop = 0,
        .first_pin_inch = 0.160,
        .last_pin_inch = 0.880,
        .pin_increment_inch = 0.144,
        .pin_num = 6,
        .pin_width_inch = 0.038,
        .elbow_inch = 0.0,
        .drill_angle = 0.0,
        .uncut_depth_inch = 0.310,
        .deepest_depth_inch = 0.125,
        ...
        .clearance = 0},
       {.manufacturer = "DOM",
        .format_name = "DOM ix TwinStar",
        .format_link = "https://www.dom-security.com/de/de/",
        .sides = 2,
        .stop = 0,
        .first_pin_inch = 0.155,
        .last_pin_inch = 0.870,
        .pin_increment_inch = 0.143,
        .pin_num = 6,
        .pin_width_inch = 0.037,
        .elbow_inch = 0.0,
        .drill_angle = 0.0,
        .uncut_depth_inch = 0.305,
        .deepest_depth_inch = 0.122,
        .depth_step_inch = 0.017,
        .min_depth_ind = 1,
        .max_depth_ind = 7,
        .macs = 2,
        .clearance = 0}
